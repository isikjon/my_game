...
class DisplayGameScreen extends StatefulWidget {
  final GameModel? game;

  const DisplayGameScreen({super.key, this.game});

  @override
  State<DisplayGameScreen> createState() => _DisplayGameScreenState();
}

class _DisplayGameScreenState extends State<DisplayGameScreen> {
